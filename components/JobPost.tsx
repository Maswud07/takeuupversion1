                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input name="company" value={jobData.company} onChange={handleInputChange} type="text" placeholder="Your Company" className="w-full bg-slate-50 dark:bg-[#1E2330] border border-slate-200 dark:border-white/10 rounded-xl pl-10 pr-4 py-3 text-slate-900 dark:text-white focus:outline-none focus:border-cyan-500 transition-colors" />
                                </div>
                            </div>
