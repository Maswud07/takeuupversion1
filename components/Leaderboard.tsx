...
export const Leaderboard = () => {
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-900 pb-20 overflow-hidden transition-colors duration-500">
        {/* Ambient Background */}
        ...
        <div className="max-w-4xl mx-auto px-4 py-8 relative z-10">
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="text-center mb-2">
                                <h3 className={`font-bold truncate max-w-[120px] ${isFirst ? 'text-slate-900 dark:text-white text-lg' : 'text-slate-700 dark:text-slate-300 text-sm'}`}>{user.name}</h3>
            ...
            {/* List Section */}
            <div className="bg-white dark:bg-slate-800/40 backdrop-blur-xl rounded-3xl border border-slate-200 dark:border-slate-700/50 p-2 md:p-6 shadow-xl dark:shadow-2xl relative overflow-hidden animate-in slide-in-from-bottom-8 duration-700 delay-200">
                {/* Header Row */}
                <div className="grid grid-cols-12 gap-4 p-4 text-xs font-bold text-slate-500 uppercase tracking-wider border-b border-slate-100 dark:border-slate-700/50 mb-2">
                    ...
                    {listData.map((user) => (
                        <div 
                            ...
                            className={`grid grid-cols-12 gap-4 items-center p-3 rounded-2xl transition-all duration-300 group hover:scale-[1.01] ${
                                ...
                                : 'bg-slate-50 dark:bg-slate-800/40 border border-transparent hover:bg-slate-100 dark:hover:bg-slate-700/50 hover:border-slate-200 dark:hover:border-slate-600'
                            }`}
                        >
                            {/* Rank */}
                            ...
                            <div className="col-span-6 md:col-span-7 flex items-center gap-4">
                                <div className="relative">
                                    <img src={user.avatar} alt={user.name} className="w-10 h-10 rounded-full border border-slate-200 dark:border-slate-600 group-hover:border-slate-300 dark:group-hover:border-slate-400 transition-colors" />
                            ...
                            <div className="col-span-4 md:col-span-4 text-right pr-4">
                                <div className="inline-flex items-center gap-2 bg-white dark:bg-slate-900/50 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 group-hover:border-slate-300 dark:group-hover:border-slate-500 transition-colors">
