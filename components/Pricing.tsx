    ...
    <div className="relative min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-900 dark:text-white font-sans selection:bg-cyan-500/30 overflow-hidden pt-20 transition-colors duration-500">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 py-16">
            ...
            <div className="text-center max-w-3xl mx-auto mb-20">
                ...
                <h1 className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white mb-6 tracking-tight leading-tight drop-shadow-sm">
                    Simple Pricing, <br/>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 dark:from-cyan-400 dark:via-blue-500 dark:to-purple-500">Unlimited Potential.</span>
                </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center max-w-6xl mx-auto mb-32">
                ...
                {/* 1. Free Starter */}
                <div className="relative bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-slate-300 dark:hover:border-slate-600 transition-all duration-300 group shadow-xl dark:shadow-none hover:-translate-y-1">
                    <div className="mb-8">
                        <div className="w-12 h-12 bg-slate-100 dark:bg-slate-800 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            <Shield className="text-slate-500 dark:text-slate-400" size={24} />
                        </div>
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Starter</h3>
                        <p className="text-slate-500 dark:text-slate-400 text-sm h-10">Essential tools to get you started.</p>
                    </div>
                    ...
                    <button 
                        ...
                        className="w-full py-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-900 dark:text-white font-bold transition-all mb-8"
                    >
                        {t('pricing_free_btn')}
                    </button>
                    ...
                    <ul className="space-y-4">
                        {['Daily Quizzes (Limited)', 'Basic Analytics', 'Community Access', 'Ad-Supported'].map((feat, i) => (
                            <li key={i} className="flex items-start gap-3 text-slate-600 dark:text-slate-400 text-sm">
                                <Check size={16} className="text-slate-900 dark:text-slate-500 shrink-0 mt-0.5" />
                                {feat}
                            </li>
                        ))}
                    </ul>
                ...
                {/* 2. Yearly (Featured) */}
                <div className="relative bg-white dark:bg-[#0F172A] border-2 border-cyan-500 rounded-[2.5rem] p-10 transform lg:scale-105 shadow-2xl shadow-cyan-500/20 z-10 overflow-hidden group">
                    ...
                    <div className="mb-8">
                        ...
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Yearly Pro</h3>
                        <p className="text-slate-500 dark:text-cyan-100/70 text-sm h-10">Maximum savings for serious learners.</p>
                    </div>
                    
                    <div className="mb-8 flex items-baseline gap-2">
                        <span className="text-6xl font-black text-slate-900 dark:text-white">৳999</span>
                        <div className="flex flex-col text-left">
                            <span className="text-slate-400 text-sm line-through">৳2400</span>
                            <span className="text-cyan-600 dark:text-cyan-400 font-bold text-xs">/year</span>
                        </div>
                    </div>

                    <button 
                        onClick={() => openPaymentModal('Yearly')}
                        className="w-full py-4 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold text-lg shadow-lg shadow-cyan-500/25 transition-all transform hover:-translate-y-1 active:scale-95 mb-8"
                    >
                        Get Yearly Access
                    </button>
                    ...
                    <ul className="space-y-4">
                        {['Everything in Monthly', 'Exclusive Live Classes', 'Mentor 1-on-1 Access', 'Offline Download', 'Priority Support'].map((feat, i) => (
                            <li key={i} className="flex items-start gap-3 text-slate-700 dark:text-white font-medium text-sm">
                ...
                <div className="relative bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-slate-300 dark:hover:border-slate-600 transition-all duration-300 group shadow-xl dark:shadow-none hover:-translate-y-1">
                    <div className="mb-8">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Monthly</h3>
                        <p className="text-slate-500 dark:text-slate-400 text-sm h-10">Flexible plan, cancel anytime.</p>
                    </div>
                    ...
                    <button 
                        ...
                        className="w-full py-4 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white font-bold border border-slate-200 dark:border-slate-700 transition-all mb-8"
                    >
                        Choose Monthly
                    </button>
                    ...
                    <ul className="space-y-4">
                        {['Unlimited Quizzes', 'Full Analytics Report', 'Job & Admission Prep', 'Ad-Free Experience'].map((feat, i) => (
                            <li key={i} className="flex items-start gap-3 text-slate-600 dark:text-slate-300 text-sm">
                                <Check size={16} className="text-purple-500 dark:text-purple-400 shrink-0 mt-0.5" />
                                {feat}
                            </li>
                        ))}
                    </ul>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Detailed Comparison</h2>
                ...
                <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden backdrop-blur-sm shadow-xl dark:shadow-none">
                    ...
                    <div className="grid grid-cols-3 p-6 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/80">
                        <div className="col-span-1 text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Feature</div>
                        <div className="text-center text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Free</div>
                        <div className="text-center text-sm font-bold text-cyan-600 dark:text-cyan-400 uppercase tracking-wider">Pro</div>
                    </div>
        ...
        {showModal && selectedPlan && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 dark:bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
                <div className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-700 rounded-3xl w-full max-w-md p-6 shadow-2xl relative animate-in zoom-in-95 duration-200">
                    <button onClick={() => setShowModal(false)} className="absolute top-4 right-4 text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full">
                        <X size={20} />
                    </button>
                    ...
                    {selectedPlan !== 'Free' && (
                        <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-xl mb-6 border border-slate-200 dark:border-slate-800">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <span className="text-slate-900 dark:text-white font-mono">৳{PLANS[selectedPlan]}</span>
                            </div>
                            {isDiscountApplied && (
